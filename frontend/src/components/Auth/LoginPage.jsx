...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      {/* Right Section */}
      <div className="w-full md:w-1/2 h-1/2 md:h-full bg-gray-100 flex flex-col justify-center items-center p-4">
        ...
        <form className="w-full max-w-sm" onSubmit={handleSubmit}>
          ...
          <div className="mb-3 relative flex items-center">
            ...
            <input
              className="shadow appearance-none border rounded w-full py-1.5 px-3 pl-8 text-sm text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="username"
              type="text"
          ...
          <div className="mb-4">
            <button
              className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-1.5 px-3 rounded text-sm focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Sign In
            </button>
        ...
        <p className="text-gray-700 text-xs text-center mb-3">--- or ---</p>
          <div className="grid grid-cols-2 gap-3">
            <button className="bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded text-xs focus:outline-none focus:shadow-outline">
            <FaGoogle className="inline mr-2" /> Google
            </button>
            <button className="bg-blue-800 hover:bg-blue-600 text-white py-1 px-2 rounded text-xs focus:outline-none focus:shadow-outline">
            <FaFacebook className="inline mr-2" /> Facebook
            </button>
            <button className="bg-blue-600 hover:bg-blue-700 text-white py-1 px-2 rounded text-xs focus:outline-none focus:shadow-outline">
            <FaLinkedin className="inline mr-2" /> LinkedIn
            </button>
            <button className="bg-gray-700 hover:bg-gray-900 text-white py-1 px-2 rounded text-xs focus:outline-none focus:shadow-outline">
